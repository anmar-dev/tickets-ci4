...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Lista de Chamados</h1>
    ...
    <div class="row form-group">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="titleModalChamado">Chamado</h5>
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="meus-chamados-tab" data-toggle="tab" href="#meus-chamados" role="tab" aria-controls="meus-chamados" aria-selected="true"><i class="fas fa-ticket-alt"></i> Meus chamados </a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" id="todos-chamados-tab" data-toggle="tab" href="#todos-chamados" role="tab" aria-controls="todos-chamados" aria-selected="false"><i class="fas fa-ticket-alt"></i> Todos os chamados</a>
                </li>
            </ul>
                ...
                <div class="tab-pane fade show active" id="meus-chamados" role="tabpanel" aria-labelledby="meus-chamados-tab">
                    <div class="d-sm-flex align-items-center mt-4 mb-4"> <!--justify-content-between-->
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mr-3" data-toggle="modal" data-target="#ModalChamado">
                            <i class="fas fa-plus-square fa-sm text-white-50"></i> Cadastrar Chamado
                        </a>
                    </div> 
                </div>
                ...
                <div class="tab-pane fade show" id="todos-chamados" role="tabpanel" aria-labelledby="todos-chamados-tab">
                    ...
                    <div class="table">
                        <div class="table-responsive">
                            <table class="table table-condensed table-hover table-sm" id="tableChamados">
                                <thead>
                                    <tr>
                                        <th>Cod</th>
                                        <th>Inicio</th>
...
<script src="<?= base_url('') ?>assets/js/pages/chamado.js"> </script>
<script>
    $(document).ready(() => {
        loadTableChamados();
    });
